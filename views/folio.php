...
<div class="folio">
    <div class="gallery-container">  
        ...
        <?php
            foreach($lang['portfolioItems'] as $item): 
            list($width, $height) = getimagesize("./images"."/".$item["full"]);
        ?>      
        <figure class="folio__item">
            <a class="folio__item__link" href='/images/<?= $item["full"] ?>' data-size='<?= $width."x".$height ?>'>
                <img src='/images/<?= $item["image"] ?>' alt="Image description" />
            </a> 
